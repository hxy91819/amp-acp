...
- **Session configuration** — Choose local or Orb execution, configure permissions (*Default* or *Bypass*), and select built-in (`low`, `medium`, `high`, `ultra`) or plugin-defined Amp agent modes via ACP config options

...
- `src/amp-remote-dial.ts` — Reads Amp's internal `getUserInfo` Dial using CLI credentials; owns authentication refresh, validation, and a credential-scoped 24-hour disk cache shared across sessions/processes
...
| `feature/amp-remote-dial` | `1bf96e52` | `5d2e0afc` | Internal; no upstream ticket |
